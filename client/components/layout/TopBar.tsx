import { Package, Bell, CheckCircle2 } from 'lucide-react';
import { User } from '@/types';
import { MOCK_DEFAULTS } from '@/constants';
          ...
          <div className="flex items-center gap-3 pl-2 lg:pl-4 border-l border-black/5">
            ...
            <div className="relative">
              <img
                ...
                alt="Avatar"
                className="w-9 h-9 lg:w-11 lg:h-11 rounded-2xl border-2 border-primary/10 object-cover shadow-md"
              />
